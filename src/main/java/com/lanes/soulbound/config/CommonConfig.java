...
public class CommonConfig {
    ...
    public static class Common
    {
        ...
        public final ForgeConfigSpec.BooleanValue enchantable;

        public final ForgeConfigSpec.BooleanValue enchantableBooks;

        public final ForgeConfigSpec.BooleanValue cursesApplicable;

        public final ForgeConfigSpec.IntValue maximumLevel;

        public final ForgeConfigSpec.IntValue rarity;

        public final ForgeConfigSpec.DoubleValue dropLevel;

        public final ForgeConfigSpec.DoubleValue additiveDropChance;

        public final ForgeConfigSpec.DoubleValue additiveSaveChance;

        public final ForgeConfigSpec.DoubleValue saveChance;

        public final ForgeConfigSpec.BooleanValue durabilityDrop;

        public final ForgeConfigSpec.BooleanValue breakItemOnZeroDurability;

        public final ForgeConfigSpec.DoubleValue additiveDurabilityDrop;

        public final ForgeConfigSpec.DoubleValue maximumDurabilityDrop;

        public final ForgeConfigSpec.DoubleValue minimumDurabilityDrop;

        public final ForgeConfigSpec.DoubleValue modeDurabilityDrop;
